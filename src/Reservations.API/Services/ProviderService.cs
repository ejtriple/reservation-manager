...
public class ProviderService : IProviderService
{
    ...
    public Task<IEnumerable<AppointmentSlotModel>> CreateProviderAppointmentSlots(string userName, DateTime startTime,
        DateTime endTime)
    {
    ...
    public Task<IEnumerable<AppointmentSlotModel>> ExpireAppointmentSlot()
    {
        ...
        var appointmentsToExpire = _dbContext.AppointmentSlot.Include(_ => _.Provider)
            .Where(x => x.AppointmentReservationExpiration < DateTime.Now).ToList();
